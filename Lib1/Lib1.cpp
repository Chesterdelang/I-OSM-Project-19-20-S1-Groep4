...
/* static */ void Lib1::print()
{
	...
	std::cout << "Hello from Lib1 with boost::gregorian::date at " << boostToday << "!" << std::endl;
	wxDateTime wxWidgetsToday = wxDateTime::Today();
	std::cout << "Hello from Lib1 with wxDateTime at " << wxWidgetsToday.FormatDate().ToAscii() << "!" << std::endl;
